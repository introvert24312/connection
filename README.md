...
- **🏷️ 标签图谱** - 智能标签系统，支持复合标签、层级管理和可视化图谱
- **📊 节点图谱** - 节点关系可视化，相似度计算和聚类分析  
- **📋 看板快选** - 888标签看板，快速筛选和导航功能
- **🗺️ 地图可视化** - 基于 MapKit 的 3D 地图视图，支持地理位置标记和坐标解析
- **⌨️ 命令面板快捷操作** - 键盘驱动的快速操作和导航，支持复合节点创建
- **📝 Markdown 支持** - 完整的 Markdown 编辑和预览功能
- **🔄 Git 支持** - 完整的版本控制，自动同步和冲突解决
- **📁 节点文件夹** - 每个节点自动创建对应的文件夹，支持图片和文档管理
